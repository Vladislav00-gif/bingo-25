const domElements = {
  ...
  document.getElementById("colorPicker").addEventListener("input", (event) => {
    ...
    // Only apply color if we're in edit mode and have a selected cell
  ...
  // Add click handler for cells in edit mode to focus them
  ...
  function updateProgress() {
    const totalCells = 25; // Total number of bingo cells
    const completedCells = document.querySelectorAll('.bingo-cell.marked').length;
